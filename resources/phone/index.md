...
- **For developers**: an extensive [export surface](./exports-server), [first-party events](./events-server) on every lifecycle moment, and a [drop-in lb-phone compatibility layer](./lb-phone-compatibility) covering exports, events, and dependencies, with a one-command data migrator.
