...
Config.MinimumCops = 3 -- How many police required to start
...
Config.Hacking = {
    FrontDoor = {
        ...
        Args = {
            ...
            -- ox_lib
            ['lib.skillCheck'] = { -- Remember to import ox_lib into this resource, if you want to use this minigame.
