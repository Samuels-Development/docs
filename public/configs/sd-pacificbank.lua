...
Config.Hacking = {
    ...
    Terminal = {
        Minigame = 'ps-varhack', -- Choose any available minigame from SD.StartHack/below listed minigames.
        Args = {
            ['ps-circle'] = {2, 20}, -- {Number of circles, Time in milliseconds}
            ['ps-maze'] = {20}, -- {Time in seconds}
            ['ps-varhack'] = {2, 3}, -- {Number of blocks, Time in seconds}
...
Config.LaserResourceName = 'mka-lasers' -- This is the name of the laser resource that's checked before attempting to use the lasers.
