...
Config.Rewards = {
    [1] = { -- Index of the crate in question
        MinAmount = 4, -- Min amount of items individually given per crate.
        MaxAmount = 6, -- Max amount of items individually given per crate.
...
-- Guards
Config.EnableGuards = false -- Enable NPC Guards for Oilrig
