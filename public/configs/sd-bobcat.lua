...
-- Map Settings
Config.MLOType = 'gabz' -- 'nopixel' = The preset coordinates for Nopixels (Tobii's) MLO, 'gabz' = The preset coordinates for Gabz's MLO, 'k4mb1' = The preset coordinates for K4MB1's MLO
...
-- Alarm Settings
Config.Alarm = {
    SoundAlarm = false, -- Enable or disable the alarm sound
